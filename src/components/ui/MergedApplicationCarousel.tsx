...
const MergedApplicationCarousel = ({
  ...
  useEffect(() => {
    const handleKeyPress = (e: KeyboardEvent) => {
      ...
      switch (e.key) {
        ...
        case " ":
          e.preventDefault();
          setIsHovering((prev) => !prev); // Toggle auto-rotation
          break;
      }
    };
  ...
  const getCardTransform = (index: number) => {
    ...
    if (diff === 0) {
      // Active card - center position with subtle forward tilt
      return {
        transform:
      ...
      // Next card - right side with perspective
      return {
        transform:
      ...
      // Previous card - left side with perspective
      return {
        transform:
          "translateX(-85%) translateZ(-100px) scale(0.85) rotateY(25deg) rotateX(5deg)",
        opacity: 0.7,
      ...
      >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 p-7 flex flex-col justify-end text-white">
                      <div className="transform transition-all duration-700 group-hover:translate-y-[-6px] group-hover:scale-[1.02]">
                        ...
                        <div className="w-12 h-0.5 bg-white/80 rounded-full drop-shadow-sm transition-all duration-500 group-hover:w-16 group-hover:h-[3px] group-hover:bg-white/90 group-hover:drop-shadow-md"></div>
                      </div>
                    </div>
        ...
        <button
          className="absolute left-4 top-1/2 -translate-y-1/2 z-50 
                     ...
                     transform hover:translate-x-[-4px] 
            ...
            >
              ...
              {active === idx && (
                <>
                  ...
                  {/* Progress ring for auto-rotation */}
