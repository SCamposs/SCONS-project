      ...
      >
        ...
        >
          ...
          {!isMobile && (
            <>
              <button
                className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full flex items-center justify-center text-white z-30 shadow-none border-none transition-all hover:scale-110 hover:-translate-x-0.5 will-change-transform bg-transparent"
                onClick={() =>
                  setActive((prev) => (prev - 1 + items.length) % items.length)
                }
                aria-label="Previous"
              ...
              <button
                className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full flex items-center justify-center text-white z-30 shadow-none border-none transition-all hover:scale-110 hover:translate-x-0.5 will-change-transform bg-transparent"
